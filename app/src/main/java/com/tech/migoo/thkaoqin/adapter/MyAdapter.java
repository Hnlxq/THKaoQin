...
/**
 * Created by Migoo_005 on 16/1/15.
 */
public abstract class MyAdapter<T> extends BaseAdapter {
    ...
    public static class ViewHolder{
        ...
        private SparseArray<View> mViews; //存放listView item中的View
         ...
         * 设置网络图片
         */
//        public ViewHolder setNetImage(int id, String picUrl){
//            View view = getView(id);
//            if (view instanceof NetImageView){
//                ((NetImageView)view).setImageByUrl(picUrl);
//            }
//            return this;
//        }
